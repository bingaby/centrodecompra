...
const totalProdutos = 1000;// Atualizar ano no footer
...
function filtrarProdutos() {
  ...
  gridProdutos.style.display = 'grid';  produtosFiltrados.forEach((produto, produtoIndex) => {
    ...
    const carrosselId = carrossel-${produtoIndex}-${produto.id || Date.now()}; // Corrigidoconst produtoDiv = document.createElement('div');
