const API_URL = 'https://centrodecompra-backend.onrender.com';let produtos = [];
...
const totalProdutos = 1000;function atualizarAnoFooter() {
  ...
  let attempt = 1;  while (attempt <= maxRetries) {
    try {
      ...
      gridProdutos.innerHTML = '';  console.log(`Tentativa ${attempt}: Carregando produtos`);
