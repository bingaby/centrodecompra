onst API_URL = 'https://centrodecompra-backend.onrender.com'; // Use 'http://localhost:10000' para testes locais// Variáveis globais
let produtos = [];
...
function configurarCliqueLogo() {
  ...
  if (!logo) {
    console.error(' ID site-logo não encontrado no DOM');
    return;
  }
  let clickCount = 0;
  let clickTimer;
